...
현재 처리량과 latency는
[ㄷ·ㅅ·ㅂ·ㅎ 불규칙 enriched 용언 lexicon](2026-07-14-consonant-irregular-enriched-lexicon.md)을
기준으로 한다.
...
FN 83, precision 100.00%, recall 83.4%, F1 90.95%다. `이다 -> 매일`은 whole-token lexical
