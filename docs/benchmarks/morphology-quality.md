...
| --- | ---: | ---: | ---: | ---: |
| dev embedded smart | 446 / 2 / 54 | 99.55% | 89.2% | 94.09% |
| dev full-POS smart | 447 / 2 / 53 | 99.55% | 89.4% | 94.20% |
| test embedded smart | 419 / 0 / 81 | 100.00% | 83.8% | 91.19% |
| test full-POS smart | 426 / 0 / 74 | 100.00% | 85.2% | 92.01% |

세부 품사와 성능 결과는
[User smart precision 품질·성능](2026-07-14-user-smart-precision.md)과
[상태 용언 현재 평서형 후속 형태 continuation](2026-07-15-descriptive-declarative-continuation.md)에
둔다.
...
1. 명시적 품사 full-POS `smart`의 development FN 53건을 기준으로 다음 후보를 조사한다.
