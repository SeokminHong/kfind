...
현재 query matrix full-POS는 raw `FP 4 / FN 4 / recall 99.69%`, contract
`FPᶜ 0 / FNᶜ 0 / recallᶜ 100%`다. 상세 결과는
[명사 결합 접미사 recall](2026-07-18-attached-nominal-suffix.md)에 둔다.
