...
별도 호스트에 올릴 수 있습니다. Smart 검색에서 복합 명사 component, 지정사 strict subspan,
등록된 동형어 문맥 판별을 사용할 때 생성자에 bytes를 전달하거나 query compile 전에
`loadComponentResource`를 호출합니다. CLI와 달리
