...
Detailed tags include NNG, NNP, NNB, NNBC, NP, NR, VV, VA, VX, VCP, VCN, J*, E*, and the X\* derivation tags.

They are analysis data in lexicons and component resources, not public option values.

## Mapping [#mapping]

A coarse POS contains several detailed tags but never includes unrelated functional tags. A `noun` query does not use JX as its core.
