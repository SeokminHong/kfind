...
<Callout title="What FNᶜ = 0 means">

The full-POS query matrix reports four raw false negatives and zero contract-adjusted false negatives from the same execution under different contracts. FNᶜ = 0 does not mean that the implementation fixed four errors.
