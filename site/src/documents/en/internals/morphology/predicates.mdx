...
Removing dictionary-form `-다` from VV verbs and VA adjectives produces the base stem. Lexicon entries provide regular or irregular substitution classes and vowel-harmony information.

A stem surface form is not a fixed prefix because it can change with the ending environment.
...
When a lemma permits both regular and irregular forms, the engine retains both programs.
