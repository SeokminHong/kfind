...
export const morphologyDocuments: TechnicalDocuments = {
  [RoutePath.MorphPartsOfSpeech]: {
    [DocumentLocale.Korean]: {
      ...
      title: '품사 체계',
      summary:
        '세부 품사는 문법 전이를 판정하고 coarse POS는 사용자가 검색 의도를 제한하는 공개 범주입니다.',
      sections: [
        section('세부 태그', [
    ...
    [DocumentLocale.English]: {
      ...
      summary:
        'Detailed POS drives grammar transitions; coarse POS lets users constrain search intent.',
      sections: [
  ...
  [RoutePath.Nominals]: {
    [DocumentLocale.Korean]: {
      ...
      title: '체언',
      summary:
        '명사·대명사·수사는 조사 host가 되며 class별 경계와 component 조건을 가집니다.',
      sections: [
        section('체언 분류', [
    ...
    [DocumentLocale.English]: {
      ...
      title: 'Nominals',
      summary:
        'Nouns, pronouns, and numerals host particles under class-specific boundary and component constraints.',
      sections: [
  ...
  [RoutePath.Particles]: {
    [DocumentLocale.Korean]: {
      ...
      title: '조사',
      summary:
        '조사는 체언 뒤의 문법 관계를 나타내며 받침 조건과 제한된 연쇄를 가진 suffix automaton으로 판정합니다.',
      sections: [
        section('조사 분류', [
        ...
        section('조사 연쇄', [
          '연쇄는 표에 등록된 다음 기능만 허용합니다. 격조사 뒤 보조사처럼 관찰된 조합은 소비하지만 임의의 J tag 연결은 허용하지 않습니다.',
          '완성된 연쇄 뒤에는 boundary가 필요합니다. 남은 suffix가 있으면 체언 match로 닫지 않습니다.',
        ]),
      ],
    },
    [DocumentLocale.English]: {
      ...
      title: 'Particles',
      summary:
        'Particles express relations after nominals and are verified by a bounded suffix automaton with coda conditions.',
      sections: [
        ...
        section('Particle chains', [
          'Only registered functional continuations are allowed. Observed combinations such as case plus auxiliary particles are consumed; arbitrary J-tag concatenation is not.',
          'A completed chain must reach a boundary. A remaining suffix prevents the nominal match from closing.',
        ]),
      ],
    },
  },
  [RoutePath.Predicates]: {
    [DocumentLocale.Korean]: {
      ...
      title: '용언',
      summary:
        '용언 program은 어간 교체, 선어말어미와 어말어미를 분리해 조합합니다.',
      sections: [
        section('어간', [
    ...
    [DocumentLocale.English]: {
      ...
      title: 'Predicates',
      summary:
        'Predicate programs compose stem substitution, prefinal endings, and final endings as separate stages.',
      sections: [
        section('Stems', [
  ...
  [RoutePath.Endings]: {
    [DocumentLocale.Korean]: {
      ...
      title: '어미',
      summary:
        '어미 automaton은 선어말어미의 순서와 어말어미의 종결 기능을 typed state로 표현합니다.',
      sections: [
        section('선어말어미', [
    ...
    [DocumentLocale.English]: {
      ...
      title: 'Endings',
      summary:
        'The ending automaton represents prefinal order and final closure as typed states.',
      sections: [
  ...
  [RoutePath.Irregulars]: {
    [DocumentLocale.Korean]: {
      ...
      title: '불규칙 활용',
      summary:
        '불규칙은 표제어별 lexical class와 어미의 음운 환경이 함께 충족될 때만 적용됩니다.',
      sections: [
        section('어휘 class', [
    ...
    [DocumentLocale.English]: {
      ...
      summary:
        'An irregular applies only when both a lemma-specific lexical class and the ending environment agree.',
      sections: [
  ...
  [RoutePath.Derivation]: {
    [DocumentLocale.Korean]: {
      ...
      title: '파생',
      summary:
        '파생 mode는 품사 전환이 명시된 제한된 접사와 source 구조만 확장합니다.',
      sections: [
        section('파생 mode', [
    ...
    [DocumentLocale.English]: {
      ...
      title: 'Derivation',
      summary:
        'Derivation expands only affixes and source structures with explicit POS-changing rules.',
      sections: [
  ...
  [RoutePath.Compounds]: {
    [DocumentLocale.Korean]: {
      ...
      title: '합성어와 보조용언',
      summary:
        '내부 성분 검색은 source가 선언한 component와 완성된 용언 연결 구조를 근거로 합니다.',
      sections: [
        section('합성명사', [
    ...
    [DocumentLocale.English]: {
      ...
      summary:
        'Internal-component search relies on source-declared components and completed predicate continuations.',
      sections: [
  ...
  [RoutePath.Contractions]: {
    [DocumentLocale.Korean]: {
      ...
      title: '축약과 영형태',
      summary:
        '축약은 문법 경로를 유지한 표면 조립이며 영형태는 source 문자가 없는 문법 node입니다.',
      sections: [
        section('축약', [
    ...
    [DocumentLocale.English]: {
      ...
      summary:
        'A contraction assembles a shorter surface while preserving grammar; a zero surface is a grammar node without source characters.',
      sections: [
  ...
  [RoutePath.Ambiguity]: {
    [DocumentLocale.Korean]: {
      ...
      title: '중의성과 경계',
      summary:
        '분석 집합을 보존하되 source 구조가 반증하는 후보는 program 단계에서 제거합니다.',
      sections: [
        section('분석 집합', [
    ...
    [DocumentLocale.English]: {
      ...
      summary:
        'Analysis sets are preserved, while candidates disproved by source structure are removed at the program layer.',
      sections: [
  ...
  [RoutePath.Coverage]: {
    ...
    [DocumentLocale.English]: {
      ...
      summary:
        'Versioned rule data, lexicon entries, and fixtures jointly define supported coverage.',
      sections: [
